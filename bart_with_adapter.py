...
class BartModelWithAdapter(BartModel): ############################ BartModel mới có forward
    def __init__(self, config: BartConfig):
    ...
    # ################################################################# c2 sửa tk kế thừa https://stackoverflow.com/questions/23646826/python-how-to-override-a-method-defined-in-a-module-of-a-third-party-library
    # def forwardd(
    #     self,
    #      input_ids=None,attention_mask=None,_decoder_input_ids=None,encoder_outputs=None,decoder_attention_mask=None,decoder_cached_states=None, use_cache=None,
...
class MyBartWithAdapter(BartForConditionalGenerationWithAdapter):
    def forward(self, input_ids, attention_mask=None, encoder_outputs=None,
            ...
            use_cache=False, is_training=False,dumbledore=None): ######################################### dumbledore
        ...
        if  CHECKPOINT == False:
            ...
            # listarg={"input_ids":input_ids,
            #     "attention_mask":attention_mask,"_decoder_input_ids":_decoder_input_ids,
            #     "encoder_outputs":encoder_outputs,
            #     "decoder_attention_mask":decoder_attention_mask,
            #     "decoder_cached_states":decoder_cached_states,
            #     "use_cache":use_cache}
            # outputs = torch.utils.checkpoint.checkpoint(self.model.forwardd, ##################################################
            #     listarg,dummy_tensor
            # )
